...
const bagle = createMenuItem("Bagle", 7, "Breakfast");
console.log(bagle);

/* Task 1b: use your function to create 3 more menu items. You may add any items to the menu that you'd like */

const oJ = createMenuItem("Orange Juice", 2, "drinks");
const bLt = createMenuItem("BLT", 8, "Lunch");
const grilledCheese = createMenuItem("Grilled Cheese", 4, "lunch");
console.log(oJ, bLt, grilledCheese);
